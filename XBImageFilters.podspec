#
#  Be sure to run `pod spec lint XBImageFilters.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of XBImageFilters in Markdown format.
  ...
  s.source       = { :git => "https://github.com/xissburg/XBImageFilters.git", :tag => "1.1.2" }
