...
- (void)viewDidLoad
{
    ...
    images = @{@"Marvin over the wire": @"http://mascot.crystalxp.net/png/fagoon-marvin-4622.png",
               @"Marvin Local": @"marvin.png",
               @"black & white": @"basn0g01.png",
               @"2 bit (4 level) grayscale": @"basn0g02.png",
               @"4 bit (16 level) grayscale": @"basn0g04.png",
               @"8 bit (256 level) grayscale": @"basn0g08.png",
               @"16 bit (64k level) grayscale": @"basn0g16.png",
               @"3x8 bits rgb color": @"basn2c08.png",
               @"3x16 bits rgb color": @"basn2c16.png",
               @"1 bit (2 color) paletted": @"basn3p01.png",
               @"2 bit (4 color) paletted": @"basn3p02.png",
               @"4 bit (16 color) paletted": @"basn3p04.png",
               @"8 bit (256 color) paletted": @"basn3p08.png",
               @"8 bit grayscale + 8 bit alpha": @"basn4a08.png",
               @"16 bit grayscale + 16 bit alpha": @"basn4a16.png",
               @"3x8 bits rgb color + 8 bit alpha": @"basn6a08.png",
               @"3x16 bits rgb color + 16 bit alpha": @"basn6a16.png",
               @"Russian ball": @"russian-ball.jpeg"};
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    //
    NSString *fileName = images[labels[row]];
...
#if 0
    imageView.image = [img imageByApplyingShaders:@[luminancePath]];
#else
    UIImage * newImg =  [img imageByApplyingShaders:@[luminancePath]];
